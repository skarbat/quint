...
This is a fork of the continued work, to make it run on the RaspberryPI using QT5 version 5.3,
with a few small usability improvements.

Thanks go to Andrew Baldwin and other committers at: https://gitorious.org/quint/quint

Albert, February 2015
